...
#SBATCH --array=1-18 	
# Name of Job
#SBATCH --job-name=mineconquer_red_0
# Location of Log Output
#SBATCH --output=/projects/flex1/jr0904/output/MGS_Paper_SI_Data/mineconquer_red_0/slurm-%A_%a.out
...
OutDir=/projects/flex1/jr0904/output/MGS_Paper_SI_Data/mineconquer_red_0

# Variables passed to analysis
# Fetch the Experiment name from the Exp list file
experiment_list=/home/jr0904/BlueGem/ExpLists/mineconquer_red_0_exp.list
Umbrella=mineconquer_red_0
Experiment=$(awk NR==${SLURM_ARRAY_TASK_ID} ${experiment_list})
Sim=${SLURM_ARRAY_TASK_ID}
CustomEndTimeName=conquerko_red_0_e
# Fetch the Gene Knock Outs from the KO list file
ko_list=/home/jr0904/BlueGem/KOLists/mineconquer_red_0_ko.list
...
# find /projects/flex1/jr0904/output/MGS_Paper_SI_Data/mineconquer_red_0 -type f -iname "*.pdf" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper_SI_Data/mineconquer_red_0/pdfs {} +
# find /projects/flex1/jr0904/output/MGS_Paper_SI_Data/mineconquer_red_0 -type f -iname "*.fig" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper_SI_Data/mineconquer_red_0/figs {} +
