...
#SBATCH --array=1-28 	
# Name of Job
#SBATCH --job-name=minedivide
# Location of Log Output
#SBATCH --output=/projects/flex1/jr0904/output/minesweeper/minedivide/slurm-%A_%a.out
...
OutDir=/projects/flex1/jr0904/output/minesweeper/minedivide

# Variables passed to analysis
# Fetch the Experiment name from the Exp list file
experiment_list=/home/jr0904/BlueGem/ExpLists/minedivide_exp.list
Umbrella=minedivide
Experiment=$(awk NR==${SLURM_ARRAY_TASK_ID} ${experiment_list})
Sim=${SLURM_ARRAY_TASK_ID}
CustomEndTimeName=divideko_e
# Fetch the Gene Knock Outs from the KO list file
ko_list=/home/jr0904/BlueGem/KOLists/minedivide_ko.list
...
# find /projects/flex1/jr0904/output/minesweeper/minedivide -type f -iname "*.pdf" -exec mv -t /projects/flex1/jr0904/output/minesweeper/minedivide/pdfs {} +
# find /projects/flex1/jr0904/output/minesweeper/minedivide -type f -iname "*.fig" -exec mv -t /projects/flex1/jr0904/output/minesweeper/minedivide/figs {} +
