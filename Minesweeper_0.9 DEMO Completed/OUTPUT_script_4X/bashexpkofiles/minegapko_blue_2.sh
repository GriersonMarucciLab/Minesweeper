...
#SBATCH --array=1-256 	
# Name of Job
#SBATCH --job-name=minegapko_blue_2
# Location of Log Output
#SBATCH --output=/projects/flex1/jr0904/output/MGS_Paper_SI_Data/minegapko_blue_2/slurm-%A_%a.out
...
OutDir=/projects/flex1/jr0904/output/MGS_Paper_SI_Data/minegapko_blue_2

# Variables passed to analysis
# Fetch the Experiment name from the Exp list file
experiment_list=/home/jr0904/BlueGem/ExpLists/minegapko_blue_2_exp.list
Umbrella=minegapko_blue_2
Experiment=$(awk NR==${SLURM_ARRAY_TASK_ID} ${experiment_list})
Sim=${SLURM_ARRAY_TASK_ID}
CustomEndTimeName=gapko_blue_2_e
# Fetch the Gene Knock Outs from the KO list file
ko_list=/home/jr0904/BlueGem/KOLists/minegapko_blue_2_ko.list
...
# find /projects/flex1/jr0904/output/MGS_Paper_SI_Data/minegapko_blue_2 -type f -iname "*.pdf" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper_SI_Data/minegapko_blue_2/pdfs {} +
# find /projects/flex1/jr0904/output/MGS_Paper_SI_Data/minegapko_blue_2 -type f -iname "*.fig" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper_SI_Data/minegapko_blue_2/figs {} +
